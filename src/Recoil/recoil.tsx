...
import SubsListSpec from '../chain_spec/SubsListSpecRaw.json'
import local from '../chain_spec/rococo-local-raw.json'
...
export const pol_api_dev = selector({
    ...
    get: async () => {
        try {
            const prov = new Detector('SubsList')
            console.log(prov)
            const res = await prov?.connect(JSON.stringify(local), JSON.stringify(SubsListSpec))
            console.log(res)
            return res
        } catch (error) {
            console.log(error)
...
export const get_cannabisProductByCount = selectorFamily({
    ...
    get: (param) => async ({get}) => {
        try {
            ...
            const res: any = await _api?.query['cannabis']['cannabisProductByCount'](param)
            return res?.toHuman()
        } catch(error) {
            console.log(error)
        }
...
export const get_cannabisProductByCategory = selectorFamily({
    ...
    get: (param) => async ({get}) => {
        try {
            const _api = get(pol_api_dev)
            const res: any = await _api?.query['cannabis']['cannabisProductsByCategory'](param)
            return res?.toJSON()
        } catch(error) {
            console.log(error)
        }
...
export const get_pol_cannabisCount = selector({
    ...
    get: async ({get}) => {
        try {
            get(update)
            const _api = get(pol_api_dev)
            const res: any = await _api?.query['cannabis']['cannabisCount']()
            return res?.toHuman()
        } catch(error) {
            console.log(error)
        }
...
export const get_terpene_by_count = selectorFamily({
    ...
    get: param => async ({get}) => {
        try {
            const _api = get(pol_api_dev)
            const res: any = await _api?.query['cannabis']['terpeneByCount'](param)
            return res?.toHuman()
        } catch(error) {
            console.log(error)
        }
...
export const get_cannabinoid_by_count = selectorFamily({
    ...
    get: param => async ({get}) => {
        try {
            const _api = get(pol_api_dev)
            const res: any = await _api?.query['cannabis']['cannabinoidByCount'](param)
            return res?.toHuman()
        } catch(error) {
            console.log(error)
        }
...
export const get_user_posts = selectorFamily({
    ...
    get: param => async ({get}) => {
      try {
        get(update)
        const _api = get(pol_api_dev)
        const posts: any = await _api?.query['socialMedia']['posts'](param)
        return posts?.toJSON()
        } catch(error) {
            console.log(error)
        }
...
export const get_post_by_count = selectorFamily({
    ...
    get: param => async ({get}) => {
      try {
        get(update)
        const _api = get(pol_api_dev)
        const posts: any = await _api?.query['socialMedia']['postByCount'](param)
        return posts?.toJSON()
        } catch(error) {
            console.log(error)
        }
...
export const get_comment_by_count = selectorFamily({
    ...
    get: param => async ({get}) => {
      try {
        get(update)
        const _api = get(pol_api_dev)
        const comment: any = await _api?.query['socialMedia']['commentsById'](param)
...
export const get_post_count = selector({
    ...
    get: async ({get}) => {
      try {
        get(update)
        const _api = get(pol_api_dev)
        const postCount: any = await _api?.query['socialMedia']['postCount']()
...
export const get_terpeneCount = selector({
    ...
    get: async ({get}) => {
        try {
            const _api = get(pol_api_dev)
            const res: any = await _api?.query['cannabis']['terpeneCount']()
            return res
        } catch(error) {
            console.log(error)
        }
...
export const get_cannabinoidCount = selector({
    ...
    get: async ({get}) => {
        try {
            const _api = get(pol_api_dev)
            const res: any = await _api?.query['cannabis']['cannabinoidCount']()
            return res
        } catch(error) {
            console.log(error)
        }
...
export const get_owner = selector({
    ...
    get: async ({get}) => {
        try{
            const _api = get(pol_api_dev)
            const res: any = await _api?.query['users']['owner']();
            return res?.toHuman()
        } catch(error) {
            console.log(error)
        }
...
export const get_cannabis_product = selectorFamily({
    ...
    get: param => async ({get}) => {
        try {
            const _api = get(pol_api_dev)
            const res: any = await _api?.query['cannabis']['cannabisProducts'](param)
            return res?.toJSON()
        } catch(error) {
            console.log(error)
        }
...
export const get_orders = selector({
    ...
    get: async ({get}) => {
        try {
            ...
            const res: any = await _api?.query['orders']['ordersByUser'](acct)
            return res?.toHuman()
        } catch(error) {
            console.log(error)
        }
...
export const get_pol_aminoByCount = selectorFamily({
    ...
    get: (param) => async ({get}) => {
        try {
            const _api = get(pol_api_dev)
            const res: any = await _api?.query['peptides']['aminoAcidByCount'](param)
            return res?.toHuman()
        } catch(error) {
            console.log(error)
        }
...
export const get_pol_peptideByCount = selectorFamily({
    ...
    get: (param) => async ({get}) => {
        try {
            get(update)
            const _api = get(pol_api_dev)
            const res: any = await _api?.query['peptides']['peptideByCount'](param)
            return res?.toHuman()
        } catch(error) {
            console.log(error)
        }
...
export const get_pol_peptideById = selectorFamily({
    ...
    get: (param) => async ({get}) => {
        try {
            const _api = get(pol_api_dev)
            const res: any = await _api?.query['peptides']['peptides'](param)
            return res?.toHuman()
        } catch(error) {
            console.log(error)
        }
...
export const get_pol_peptideCount = selector({
    ...
    get: async ({get}) => {
        try {
            get(update)
            const _api = get(pol_api_dev)
            const res: any = await _api?.query['peptides']['peptideCount']()
            return res?.toJSON()
        } catch(error) {
            console.log(error)
        }
...
export const get_pol_aminoAcidCount = selector({
    ...
    get: async ({get}) => {
        try {
            get(update)
            const _api = get(pol_api_dev)
            const res: any = await _api?.query['peptides']['aminoAcidCount']()
            return res?.toHuman()
        } catch(error) {
            console.log(error)
        }
